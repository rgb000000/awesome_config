...
theme.wallpapers                                = {
                                                    theme.confdir .. "/forest.jpg",
                                                    theme.confdir .. "/mountain.jpg"
                                                }
...
theme.weather = lain.widget.weather({
    city_id = 1790630, -- placeholder (London)
...
--    s.mybottomwibox = awful.wibar({ position = "bottom", screen = s, border_width = 0, height = dpi(10), bg = theme.bg_normal, fg = theme.fg_normal })
--
